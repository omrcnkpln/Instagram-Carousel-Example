...
function sliderPlay(boxItems1, boxItems2, boxItems3, boxItems4, boxItems5) {
  ...
  boxItems1.eq(indexForBox1 - 2).removeClass('passive');

  // _____________________________ 2.box hareket _____________________________________________________________
  ...
  boxItems2.eq(indexForBox2 - 2).removeClass('passive');

  // _____________________________ 3.box hareket _____________________________________________________________
  ...
  boxItems3.eq(indexForBox3 - 2).removeClass('passive');

  // _____________________________ 4.box hareket _____________________________________________________________
  ...
  boxItems4.eq(indexForBox4 - 2).removeClass('passive');

  // _____________________________ 5.box hareket _____________________________________________________________
...
$(document).ready(() => {
  const boxItems1 = $('.img-box-1 .slider-wrapper .image-cover');
  const boxItems2 = $('.img-box-2 .slider-wrapper .image-cover');
  const boxItems3 = $('.img-box-3 .slider-wrapper .image-cover');
  const boxItems4 = $('.img-box-4 .slider-wrapper .image-cover');
  const boxItems5 = $('.img-box-5 .slider-wrapper .image-cover');
